...
public class ResponseCollection<R> implements Serializable {
	...
	public static <T> ResponseCollection<T> failNotice(String message) {
		return new ResponseCollection<T>(SystemCode.FAIL.code(), message);
	}

	public static <T> ResponseCollection<T> fail() {
		return new ResponseCollection<T>(SystemCode.FAIL);
	}
	...
	public static <T> ResponseCollection<T> notLogin() {
		return new ResponseCollection<T>(SystemCode.NOT_LOGIN);
	}

	public static <T> ResponseCollection<T> notLogin(String message) {
		return new ResponseCollection<T>(SystemCode.NOT_LOGIN.code(),
				message);
	}

	public static <T> ResponseCollection<T> success() {
		return new ResponseCollection<T>(SystemCode.SUCCESS);
	}

	public static <T> ResponseCollection<T> successNotice(String message) {
		return new ResponseCollection<T>(SystemCode.SUCCESS.code(), message);
	}

	public static <T> ResponseCollection<T> success(Collection<T> result,
			PageInfo page) {
		return new ResponseCollection<T>(SystemCode.SUCCESS, result, page);
	}

	public static <T> ResponseCollection<T> success(Collection<T> result) {
		return new ResponseCollection<T>(SystemCode.SUCCESS,result);
	}

	public static <T> ResponseCollection<T> failException(Collection<T> result) {
		return new ResponseCollection<T>(SystemCode.FAIL,result);
	}
