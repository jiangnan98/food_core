...
public class ResponseResult<R> implements Serializable {
	...
	public ResponseResult(String code, String message, R result) {
		this.code = code;
		if (this.code == SystemCode.SUCCESS.code())
			this.success = true;
		this.msg = message;
		this.result = result;
	}
	...
	public static <T> ResponseResult<T> failNotice(String message) {
		return new ResponseResult<T>(SystemCode.FAIL.code(), message);
	}
	...
	public static <T> ResponseResult<T> fail() {
		return new ResponseResult<T>(SystemCode.FAIL);
	}

	public static <T> ResponseResult<T> fail(String message, T result) {
		return new ResponseResult<T>(SystemCode.FAIL.code(), message, result);
	}
	...
	public static <T> ResponseResult<T> paramError(String message) {
		return new ResponseResult<T>(SystemCode.PARAMS_ERROR.code(), message);
	}

	public static <T> ResponseResult<T> notLogin() {
		return new ResponseResult<T>(SystemCode.NOT_LOGIN);
	}

	public static <T> ResponseResult<T> notLogin(String message) {
		return new ResponseResult<T>(SystemCode.NOT_LOGIN.code(), message);
	}

	public static <T> ResponseResult<T> success() {
		return new ResponseResult<T>(SystemCode.SUCCESS);
	}

	public static <T> ResponseResult<T> successNotice(String message) {
		return new ResponseResult<T>(SystemCode.SUCCESS.code(), message);
	}

	public static <T> ResponseResult<T> success(T result) {
		return new ResponseResult<T>(SystemCode.SUCCESS, result);
	}
	public static <T> ResponseResult<T> failException(T result) {
		return new ResponseResult<T>(SystemCode.FAIL, result);
	}
